...
<html lang="en">
    <head>
        ...
        <title>Doccure - Posts Page</title>
...
?>
												...
												<tr>
													...
													<td>
														...
														<?php  echo "<img src='post_uploads/$postImage' height='100px' width='100px'"; ?>
                                                        </a>
															<a href="profile.html"><?php echo $post_title ?></a>
														</h2>
													</td>
												
													<td class="text-end">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-bs-toggle="modal" href="#edit_specialities_details<?php echo $post_id ?>">
																<i class="fe fe-pencil"></i> Edit
															</a>
															<a  data-bs-toggle="modal" href="#delete_modal<?php echo $post_id ?>" class="btn btn-sm bg-danger-light">
			...
			<div class="modal fade" id="delete_modal<?php echo $post_id ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-body">
							<div class="form-content p-2">
							<form action="delete.php?id=<?php echo $post_id ?>" method="POST">
								<h4 class="modal-title">Delete</h4>
								<p class="mb-4">Are you sure want to delete?<?php echo $post_id ?></p>
			...
			<!-- Edit Details Modal -->
			<div class="modal fade" id="edit_specialities_details<?php echo $post_id ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form action="update.php?id=<?php echo $post_id ?>" method="POST" enctype="multipart/form-data">
								<div class="row form-row">
											<input type="hidden" name="id" class="form-control" value="<?php echo $post_id?>">
                                    ...
                                    <div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="post_description" value="<?php echo $post_description?>">
										</div>
									</div>
									 <div class="col-12 col-sm-6">
										<div class="form-group">
											<label>Image</label>
											<input type="file"  class="form-control" name="post_img" value= "<?php  echo "<img src='post_uploads/$postImage' height='100px' width='100px'"; ?>>"
										</div>
									</div> 
